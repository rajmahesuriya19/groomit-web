                    ...
                    <div className="bg-white rounded-[15px] shadow-md p-4 md:p-6 flex flex-col md:flex-row gap-8">
                        ...
                        <div className="flex flex-col gap-6 md:w-1/2">
                            ...
                            <div className="flex flex-col md:flex-row gap-6">
                                ...
                                <div className="hidden md:flex flex-1 flex-col gap-2">
                                    <label className="text-[14px] font-bold text-[#2E2E2E] font-inter">Full Name</label>
                            ...
                            <div className="flex md:hidden gap-4">
                                <div className="w-1/2 flex flex-col gap-2">
                                    <label className="text-[14px] font-bold text-[#2E2E2E] font-inter">First Name</label>
                                    <input
                                        type="text"
                                        placeholder="First Name"
                                        {...register('firstName')}
                                        className="w-full rounded-md border border-[#E2E2E2] px-4 py-2 text-[16px] font-inter placeholder:text-gray-300"
                                    />
                                </div>
                                <div className="w-1/2 flex flex-col gap-2">
                                    <label className="text-[14px] font-bold text-[#2E2E2E] font-inter">Last Name</label>
                                    <input
                                        type="text"
                                        placeholder="Last Name"
                                        {...register('lastName')}
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className="text-[#2E2E2E] font-inter font-bold text-[14px]">Change Password</span>
                                </div>
                        ...
                        <div className="flex flex-col md:w-1/2 gap-6">
                            ...
                            <div className="flex flex-col gap-2">
                                <label className="text-[14px] font-bold text-[#2E2E2E] font-inter">Email Address</label>
                                <div className="relative">
                                    <input
                                        type="email"
                                        placeholder="Email Address"
                                        {...register("email")}
                                        className="w-full rounded-md border border-[#E2E2E2] px-4 pr-10 py-2 text-[16px] font-inter placeholder:text-gray-300"
                                    />
                                    <div className="absolute inset-y-0 right-3 flex items-center">
                            ...
                            {/* Phone */}
                            <div className="flex flex-col gap-2">
                                <label className="text-[14px] font-bold text-[#2E2E2E] font-inter">Phone Number</label>
                                <div className="relative">
                                    <input
                                        type="text"
