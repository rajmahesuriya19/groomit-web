...
import { clearSelectedChat, fetchInboxMessages, fetchSupportInboxMessages } from '@/utils/store/slices/inbox/inboxSlice';
import SupoortChat from './Support/SupoortChat';
import GroomersChat from './Groomers/GroomersChat';
import SupoortInbox from './Support/SupoortInbox';
import GroomersInbox from './Groomers/GroomersInbox';
                ...
                {tabs.map((tab, index) => (
                    <CustomTabPanel key={index} value={activeTab} index={index}>
                        {tab.type === 'groomers' && groomersChat.length > 0 ? (
                            <>
                                <GroomersInbox groomersChat={groomersChat} selectedChat={selectedChat} />
                            </>

                        ) : tab.type === 'support' && supportChat.length > 0 ? (
                            <>
                                <SupoortInbox supportChat={supportChat} selectedChat={selectedChat} />
                            </>
