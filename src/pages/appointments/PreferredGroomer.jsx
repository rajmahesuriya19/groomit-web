        ...
        <div className="mt-4 pt-3 border-t border-gray-200">
            <div className="flex items-start gap-4">
                ...
                <div className="flex gap-2">
                    <ActionIcon
                        icon={item?.groomer?.isAllowedMessage ? Message : 'https://groomit.me/v7/images/webapp/icons/message-gray.svg'}
                    />
                    <ActionIcon
                        icon={item?.groomer?.isAllowedCall ? Call : 'https://groomit.me/v7/images/webapp/icons/call-gray.svg'}
                    />
                </div>
            </div>
