    ...
    useEffect(() => {
        if (selectedPet && isEdit) {
            reset({
                ...
                date_of_birth: formatToMMYYYY(selectedPet.date_of_birth), // ✅ show as MM/YYYY
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    <div className="space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-[1fr_auto_1fr] gap-6">
                            {/* Left Card */}
                            <div className="bg-white rounded-[20px] p-4 md:p-6 shadow-sm space-y-4">
                                    ...
                                    <div className="relative w-[110px] h-[110px] mx-auto shrink-0">
                                        ...
                                        <input
                                            ...
                                            onChange={(e) => {
                                                ...
                                                if (file) {
                                                    setValue('profile_photo', file) // ✅ RHF update
                                                }
                                            }}
                                        />
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {[
                                            { label: 'S(1-20lbs)', id: 2 },
                                            { label: 'M(21-40lbs)', id: 3 },
                                            { label: 'L(41-80lbs)', id: 4 },
                                            { label: 'XL(81-99lbs)', id: 5 },
                                            { label: 'XXL(100lbs+)', id: 6 },
                                        ].map((size) => (
                                            <button
                                                type="button"
                                                key={size.id}
                                                onClick={() => setValue('size_id', size.id)}
                                                className={`px-3.5 py-3 border rounded-[10px] ${selectedSize == size.id
                                                    ? 'bg-brand text-white'
