...
const CancelAppointemntModal = ({ open, onClose, onConfirm, icon, title, description, lastConfirm }) => {
    return (
        <Modal open={open} onClose={onClose}>
            <Box sx={modalStyle} className="relative text-center font-inter">
                ...
                {/* Last Asking */}
                <p className="text-primary-dark text-base font-bold leading-[23px] tracking-[-0.02em] text-center mb-6">
                    {lastConfirm}
                </p>
...
export default CancelAppointemntModal;
