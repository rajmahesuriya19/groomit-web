...
const PaymentFailedDetail = ({ selectedAppointment }) => {
...
export default PaymentFailedDetail;

/* ✂️ Shave Down Actions */
const ShaveDownSection = ({ pet }) => {
    if (!pet) return null;

    const addon = pet[0]?.addons?.[0];
    const prodName = addon?.prod_name || pet?.package?.prod_name;
    const amount = addon?.amt_show || pet?.groomer_addon_amount;
        ...
        <div>
            ...
            <div className="flex flex-col gap-3 mt-4 pt-3 border-t border-gray-200">
                <p className="font-inter font-normal text-xs text-[#4B5563]">
                    We ran into an issue with your payment. Please check or update your payment information.
                </p>
            ...
            <div className="mt-4 pt-3 border-t border-gray-200">
                <div className="flex items-end gap-4">
                    <div className="flex-1">
                        <p className="font-inter font-bold text-sm text-primary-dark">{pet[0]?.name}</p>
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex gap-2">
                    <ActionIcon icon={isAllowedMessage
                        ? 'https://groomit.me/v7/images/webapp/icons/message-color.svg'
                        : 'https://groomit.me/v7/images/webapp/icons/message-gray.svg'}
                    />
                    <ActionIcon icon={isAllowedCall
                        ? 'https://groomit.me/v7/images/webapp/icons/call-color.svg'
                        : 'https://groomit.me/v7/images/webapp/icons/call-gray.svg'}
                    />
                </div>
            </div>
