...
const CanceledByYouDetail = ({ selectedAppointment }) => {
    ...
    return (
        <>
            <Card borderColor="#EB5757">
                ...
                />
                <ShaveDownSection pet={selectedAppointment?.appt_detail} />
            </Card>
...
export default CanceledByYouDetail;
        ...
        <div>
            ...
            <div className="flex flex-col gap-3 mt-4 pt-3 border-t border-gray-200">
                <div className="font-inter font-bold text-xs text-[#1F2937]">
                    Reason:{" "}
                    <span className="font-normal text-[#4B5563]">{pet?.note}</span>
                </div>
